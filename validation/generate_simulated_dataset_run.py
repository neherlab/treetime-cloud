...
if  __name__ == '__main__':
    ...
    utils_sim.run_treetime(basename, outfile, fasttree=False, failed=None, max_iter=3, long_branch=long_branch)
    ...
    utils_sim.run_treetime(basename, outfile, fasttree=True, failed=None, max_iter=3, long_branch=long_branch)
