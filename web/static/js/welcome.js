...
/***/ function(module, exports, __webpack_require__) {
	...
	var TreeTimeForm = _react2.default.createClass({
	    ...
	    handle_run: function handle_run() {
	        ...
	        request.post("/" + this.state.UID).set('Content-Type', 'application/json').send({ settings: this.state.settings }).end(this.on_run_status);
	    },
	    ...
	    on_settings_changed: function on_settings_changed(name, setting) {
	    ...
	    uploadTreeFile: function uploadTreeFile(evt) {
	        ...
	        request.post('/upload/' + this.state.UID + '/file').send(formData).end(this.on_upload_tree);
	    },

	    on_upload_tree: function on_upload_tree(err, res) {
	        if (err) {
	    ...
	    uploadAlnFile: function uploadAlnFile(evt) {
	        ...
	        request.post('/upload/' + this.state.UID + '/file').send(formData).end(this.on_upload_aln);
	    },
	    on_upload_aln: function on_upload_aln(err, res) {
	        if (err) {
	    ...
	    uploadMetaFile: function uploadMetaFile(evt) {
	        ...
	        request.post('/upload/' + this.state.UID + '/file').send(formData).end(this.on_upload_meta);
	    },
	    on_upload_meta: function on_upload_meta(err, res) {
	        if (err) {
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement('div', null, _react2.default.createElement(_header2.default, null), _react2.default.createElement('div', { id: 'welcome_container' }, _react2.default.createElement('h2', null, 'Welcome'), _react2.default.createElement('div', { id: 'welcome_welcome' }, _react2.default.createElement('p', null, 'Welcome to the TreeTime server. The description and HOWTO will appear here shortly. Please scroll down in order to run tree-time on the server.')), _react2.default.createElement('h2', null, 'Run TreeTime on server:'), _react2.default.createElement('h3', null, '1. Upload data'), _react2.default.createElement('div', { id: 'welcome_files' }, _react2.default.createElement('div', { id: 'welcome_treeupload' }, _react2.default.createElement('h4', { 'class': 'welcome-reeupload-header' }, ' Upload tree file: '), _react2.default.createElement('input', { id: 'welcome_input_tree',
	            ...
	            onChange: this.uploadMetaFile }))), _react2.default.createElement('h3', null, '2. Configure parameters'), _react2.default.createElement('div', { id: 'welcome_params' }, _react2.default.createElement(ShouldReuseBranchLength, { settings: {
	                ...
	                settings: this.state.settings,
	                change_handle: this.on_settings_changed
	            } })), _react2.default.createElement('div', null, _react2.default.createElement('input', { type: 'button', id: 'welcome_run', onClick: this.handle_run }))), _react2.default.createElement(_footer2.default, null));
	    }
	});

	/////////////// rendering

	_reactDom2.default.render(_react2.default.createElement(TreeTimeForm, { settings: settings }), document.getElementById('react'));
