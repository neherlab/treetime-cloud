...
/***/ function(module, exports, __webpack_require__) {
	...
	var Banner = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement('div', null, _react2.default.createElement('div', null, _react2.default.createElement('h3', null, 'TreeTime is running...'), _react2.default.createElement('h4', null, 'This may take a while. You will be redirected to the results page when its done')));
	    }
	});
	...
	var Status = _react2.default.createClass({
	    ...
	    //'border-width' : '1px'
	    render: function render() {
	        return _react2.default.createElement('div', { style: this.statusStyle }, _react2.default.createElement('h4', null, this.props.status));
	    }
	});
	...
	var StepName = _react2.default.createClass({
	    ...
	    //'border-width' : '1px'
	    render: function render() {
	        return _react2.default.createElement('div', { style: this.style }, _react2.default.createElement('h4', null, this.props.step));
	    }
	});
	...
	var Step = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement('div', { style: this.style }, _react2.default.createElement(Status, { status: this.props.status }), _react2.default.createElement(StepName, { step: this.props.step }));
	    }
	});
	...
	var Progress = _react2.default.createClass({
	    ...
	    request_session_state: function request_session_state() {
	        ...
	        request.get('/' + this.state.UID + '/session_state').send({ UID: this.state.UID }).end(this.on_session_state);
	    },
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement('div', { style: this.progressStyle }, _react2.default.createElement(_header2.default, null), _react2.default.createElement(Body, {
	            appState: this.state,
	            setAppState: this.setAppState }), _react2.default.createElement(_footer2.default, null));
	    }
	});
	...
	var Body = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement('div', { style: this.bodyStyle }, _react2.default.createElement(Banner, null), this.props.appState.steps.map(this.render_step));
	    }
	});

	_reactDom2.default.render(_react2.default.createElement(Progress, null), document.getElementById('react'));
