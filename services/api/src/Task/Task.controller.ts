...
export interface PostTaskResultsRequest {}

export interface PostTaskResultsResponse {}
...
export class TaskController {
  ...
  public async postTaskResults(@Body() body: PostTaskResultsRequest): Promise<PostTaskResultsResponse> {
